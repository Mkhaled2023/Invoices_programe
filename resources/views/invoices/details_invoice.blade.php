...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto"> List</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                                ...
                                <div class=" tab-menu-heading">
                                    <div class="tabs-menu1">
                                        ...
                                        <ul class="nav panel-tabs main-nav-line">
                                            <li><a href="#tab4" class="nav-link active" data-toggle="tab">Info
                                                Bill</a></li>
                                            <li><a href="#tab5" class="nav-link" data-toggle="tab">Payment cases</a></li>
                                                ...
                                                <table class="table table-striped" style="text-align:center">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th scope="row"> Amount of collection</th>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Delete the attachment</h5>
