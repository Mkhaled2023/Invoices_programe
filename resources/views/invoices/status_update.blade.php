                ...
                <div class="card-body">
                    <form action="{{ route('Status_Update', ['id' => $invoices->id]) }}" method="post" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <label for="inputName" class="control-label"> Amount of collection</label>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select class="form-control" id="Status" name="Status" required>
                                    ...
                                    <option value="مدفوعة">paid</option>
                                    <option value="الغير مدفوعة">unpaid</option>
                                    <option value="مدفوعة جزئيا">Partially paid</option>
                                </select>
                            </div>
