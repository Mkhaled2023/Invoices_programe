...
@section('title')
Perrmissions to sell - to the legal department
@stop
...
@if (session()->has('Add'))
    <script>
        window.onload = function() {
            notif({
                msg: "The permissions has been added successfully",
                type: "success"
            });
        }
...
@if (session()->has('delete'))
    <script>
        window.onload = function() {
            notif({
                msg: "The permission has been deleted successfully.",
                type: "error"
            });
        }
                                ...
                                <tr>
                                    ...
                                    <td>
                                            ...
                                            <a class="btn btn-success btn-sm"
                                                href="{{ route('roles.show', $role->id) }}">display</a>
