...
@section('title')
Add a user - to the legal department
@stop
...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">Users</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ addition
                user</span>
        </div>
    </div>
</div>
                    ...
                    <div class="row row-sm mg-b-20">
                        <div class="col-lg-6">
                            ...
                            <select name="Status" id="select-beast" class="form-control  nice-select  custom-select">
                                <option value="مفعل">Activated</option>
                                <option value="غير مفعل"> not activated</option>
                            </select>
                        </div>
                    </div>
